...
class CartProductCard extends StatelessWidget {
  const CartProductCard(
      this.product, this.cartController, this.itemViewController,
      {Key? key})
      : super(key: key);
                    ...
                    child: Column(
                      children: [
                        (product.item_image.toLowerCase().isEmpty)
                            ? Image.asset(
                                'assets/images/no-image-icon-15.png',
                                height: 100,
                                width: 100,
                              )
                            : Image.network(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 5),
                        Obx(() => Text(
                              'Saving ₹${((double.parse(product.item_mrp) - double.parse(product.offer_price)) * product.cartCount.value).toDouble()}',
                              style: const TextStyle(
                                  color: Colors.red, fontSize: 12),
                            )),
